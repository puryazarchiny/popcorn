...
export function MovieDetails() {
  ...
  return (
    <div className="CONTAINER | col-span-2 grid grid-cols-1 justify-items-center gap-4 rounded-lg bg-slate-900 p-4 lg:grid-cols-[auto,1fr]">
      ...
      <ul className="grid grid-cols-1 grid-rows-[auto,auto,auto,auto,auto,auto,auto,auto,1fr] gap-4 p-4">
        <li>
        ...
        <li>
          <ul className="grid grid-cols-[auto,auto,1fr] justify-items-start gap-2">
            {tags}
          </ul>
        </li>
        <li>
